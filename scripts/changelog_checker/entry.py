...
def check_link(link: str, pr_number: int) -> Tuple[str, List[str]]:
    ...
    if not link.startswith("https://github.com/silcprotocol/silc/pull/"):
        fixed = f"https://github.com/silcprotocol/silc/pull/{pr_number}"
        problems.append(f'PR link should point to silc repository: "{link}"')
