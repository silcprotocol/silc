...
import (
	...
	"github.com/silcprotocol/silc/wallets/accounts"
...
var _ sdkledger.SECP256K1 = &SilcSECP256K1{}

// SilcSECP256K1 defines a wrapper of the Ethereum App to
// for compatibility with Cosmos SDK chains.
type SilcSECP256K1 struct {
	*usbwallet.Hub
...
func (e SilcSECP256K1) Close() error {
...
func (e SilcSECP256K1) GetPublicKeySECP256K1(hdPath []uint32) ([]byte, error) {
	if e.PrimaryWallet == nil {
...
func (e SilcSECP256K1) SignSECP256K1(hdPath []uint32, signDocBytes []byte, _ byte) ([]byte, error) {
...
func (e SilcSECP256K1) displayEIP712Hash(typedData apitypes.TypedData) error {
...
func (e *SilcSECP256K1) connectToLedgerApp() (sdkledger.SECP256K1, error) {
