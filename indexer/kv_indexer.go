...
var _ silctypes.EVMTxIndexer = &KVIndexer{}
...
func (kv *KVIndexer) GetByTxHash(hash common.Hash) (*silctypes.TxResult, error) {
...
func (kv *KVIndexer) GetByBlockAndIndex(blockNumber int64, txIndex int32) (*silctypes.TxResult, error) {
...
func saveTxResult(codec codec.Codec, batch dbm.Batch, txHash common.Hash, txResult *silctypes.TxResult) error {
