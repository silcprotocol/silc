...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "silc_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "SILC_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Silc_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "silc_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "silc_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "silc_silc_2024-1", true, nil,
		},
		{
			"invalid epoch, undefined", "silc_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "silc_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
