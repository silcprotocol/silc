...
// NewSilcCoin is a utility function that returns an "aevmos" coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewSilcCoin(amount sdkmath.Int) sdk.Coin {
	return sdk.NewCoin(AttoSilc, amount)
}

// NewSilcDecCoin is a utility function that returns an "aevmos" decimal coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewSilcDecCoin(amount sdkmath.Int) sdk.DecCoin {
	return sdk.NewDecCoin(AttoSilc, amount)
}

// NewSilcCoinInt64 is a utility function that returns an "aevmos" coin with the given int64 amount.
// The function will panic if the provided amount is negative.
