...
string constant MSG_CREATE_CLAWBACK_VESTING_ACCOUNT = "/silc.vesting.v2.MsgCreateClawbackVestingAccount";
string constant MSG_FUND_VESTING_ACCOUNT = "/silc.vesting.v2.MsgFundVestingAccount";
string constant MSG_CLAWBACK = "/silc.vesting.v2.MsgClawback";
string constant MSG_CONVERT_VESTING_ACCOUNT = "/silc.vesting.v2.MsgConvertVestingAccount";
string constant MSG_UPDATE_VESTING_FUNDER = "/silc.vesting.v2.MsgUpdateVestingFunder";
