...
const (
	Query_Period_FullMethodName             = "/silc.inflation.v1.Query/Period"
	Query_EpochMintProvision_FullMethodName = "/silc.inflation.v1.Query/EpochMintProvision"
	Query_SkippedEpochs_FullMethodName      = "/silc.inflation.v1.Query/SkippedEpochs"
	Query_CirculatingSupply_FullMethodName  = "/silc.inflation.v1.Query/CirculatingSupply"
	Query_InflationRate_FullMethodName      = "/silc.inflation.v1.Query/InflationRate"
	Query_Params_FullMethodName             = "/silc.inflation.v1.Query/Params"
)
