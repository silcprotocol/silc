...
func init() {
	...
	md_GenesisState = File_silc_erc20_v1_genesis_proto.Messages().ByName("GenesisState")
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_silc_erc20_v1_genesis_proto_msgTypes[0]
...
func init() {
	file_silc_erc20_v1_genesis_proto_init()
	md_Params = File_silc_erc20_v1_genesis_proto.Messages().ByName("Params")
...
func (x *Params) slowProtoReflect() protoreflect.Message {
	mi := &file_silc_erc20_v1_genesis_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_silc_erc20_v1_genesis_proto_rawDescGZIP(), []int{0}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return file_silc_erc20_v1_genesis_proto_rawDescGZIP(), []int{1}
}
...
var File_silc_erc20_v1_genesis_proto protoreflect.FileDescriptor

var file_silc_erc20_v1_genesis_proto_rawDesc = []byte{
...
var (
	file_silc_erc20_v1_genesis_proto_rawDescOnce sync.Once
	file_silc_erc20_v1_genesis_proto_rawDescData = file_silc_erc20_v1_genesis_proto_rawDesc
)

func file_silc_erc20_v1_genesis_proto_rawDescGZIP() []byte {
	file_silc_erc20_v1_genesis_proto_rawDescOnce.Do(func() {
		file_silc_erc20_v1_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_silc_erc20_v1_genesis_proto_rawDescData)
	})
	return file_silc_erc20_v1_genesis_proto_rawDescData
}

var file_silc_erc20_v1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_silc_erc20_v1_genesis_proto_goTypes = []interface{}{
	(*GenesisState)(nil), // 0: silc.erc20.v1.GenesisState
	(*Params)(nil),       // 1: silc.erc20.v1.Params
	(*TokenPair)(nil),    // 2: silc.erc20.v1.TokenPair
}
var file_silc_erc20_v1_genesis_proto_depIdxs = []int32{
...
func init() { file_silc_erc20_v1_genesis_proto_init() }
func file_silc_erc20_v1_genesis_proto_init() {
	if File_silc_erc20_v1_genesis_proto != nil {
		return
	}
	file_silc_erc20_v1_erc20_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_silc_erc20_v1_genesis_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_silc_erc20_v1_genesis_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Params); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_silc_erc20_v1_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_silc_erc20_v1_genesis_proto_goTypes,
		DependencyIndexes: file_silc_erc20_v1_genesis_proto_depIdxs,
		MessageInfos:      file_silc_erc20_v1_genesis_proto_msgTypes,
	}.Build()
	File_silc_erc20_v1_genesis_proto = out.File
	file_silc_erc20_v1_genesis_proto_rawDesc = nil
	file_silc_erc20_v1_genesis_proto_goTypes = nil
	file_silc_erc20_v1_genesis_proto_depIdxs = nil
}
