...
func init() {
	...
	md_EpochInfo = File_silc_epochs_v1_genesis_proto.Messages().ByName("EpochInfo")
...
func (x *EpochInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_silc_epochs_v1_genesis_proto_msgTypes[0]
...
func init() {
	file_silc_epochs_v1_genesis_proto_init()
	md_GenesisState = File_silc_epochs_v1_genesis_proto.Messages().ByName("GenesisState")
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_silc_epochs_v1_genesis_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (*EpochInfo) Descriptor() ([]byte, []int) {
	return file_silc_epochs_v1_genesis_proto_rawDescGZIP(), []int{0}
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_silc_epochs_v1_genesis_proto_rawDescGZIP(), []int{1}
}
...
var File_silc_epochs_v1_genesis_proto protoreflect.FileDescriptor

var file_silc_epochs_v1_genesis_proto_rawDesc = []byte{
...
var (
	file_silc_epochs_v1_genesis_proto_rawDescOnce sync.Once
	file_silc_epochs_v1_genesis_proto_rawDescData = file_silc_epochs_v1_genesis_proto_rawDesc
)

func file_silc_epochs_v1_genesis_proto_rawDescGZIP() []byte {
	file_silc_epochs_v1_genesis_proto_rawDescOnce.Do(func() {
		file_silc_epochs_v1_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_silc_epochs_v1_genesis_proto_rawDescData)
	})
	return file_silc_epochs_v1_genesis_proto_rawDescData
}

var file_silc_epochs_v1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_silc_epochs_v1_genesis_proto_goTypes = []interface{}{
	(*EpochInfo)(nil),             // 0: silc.epochs.v1.EpochInfo
	(*GenesisState)(nil),          // 1: silc.epochs.v1.GenesisState
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 3: google.protobuf.Duration
}
var file_silc_epochs_v1_genesis_proto_depIdxs = []int32{
...
func init() { file_silc_epochs_v1_genesis_proto_init() }
func file_silc_epochs_v1_genesis_proto_init() {
	if File_silc_epochs_v1_genesis_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_silc_epochs_v1_genesis_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_silc_epochs_v1_genesis_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_silc_epochs_v1_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_silc_epochs_v1_genesis_proto_goTypes,
		DependencyIndexes: file_silc_epochs_v1_genesis_proto_depIdxs,
		MessageInfos:      file_silc_epochs_v1_genesis_proto_msgTypes,
	}.Build()
	File_silc_epochs_v1_genesis_proto = out.File
	file_silc_epochs_v1_genesis_proto_rawDesc = nil
	file_silc_epochs_v1_genesis_proto_goTypes = nil
	file_silc_epochs_v1_genesis_proto_depIdxs = nil
}
