...
// The initial V2InflationDistribution can be calculated from the Silc Token
// Model like this:
...
func init() {
	proto.RegisterType((*V2InflationDistribution)(nil), "silc.inflation.v1.V2InflationDistribution")
	proto.RegisterType((*V2ExponentialCalculation)(nil), "silc.inflation.v1.V2ExponentialCalculation")
}

func init() {
	proto.RegisterFile("silc/inflation/v1/inflation.proto", fileDescriptor_d064cb35c3ff7df8)
}
