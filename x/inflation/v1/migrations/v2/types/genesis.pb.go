...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "silc.inflation.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "silc.inflation.v1.V2Params")
}

func init() { proto.RegisterFile("silc/inflation/v1/genesis.proto", fileDescriptor_1cb8eee530db1235) }
