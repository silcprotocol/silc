...
import (
	...
	"github.com/silcprotocol/silc/ibc"
...
// registered via governance. Note that the native staking denomination (e.g. "sillet"),
...
func (k Keeper) ConvertCoinToERC20FromPacket(ctx sdk.Context, data transfertypes.FungibleTokenPacketData) error {
	...
	case pair.IsNativeERC20():
		...
		// assume that all module accounts on Silc need to have their tokens in the
