# Silc Contributor Guidelines

<!-- markdown-link-check-disable -->
- [Silc Contributor Guidelines](#evmos-contributor-guidelines)
...
Thank you for considering making contributions to Silc and related repositories!

Silc uses [Tendermint’s coding repo](https://github.com/tendermint/coding)
...
3. If you would like to contribute:
    1. If the issue is a proposal, ensure that the proposal has been accepted by the Silc team.
    ...
    8. Please make sure to run `make format` before every commit -
       ...
       There are CI tests built into the Silc repository
...
When proposing an architecture decision for Silc,
...
with [gogoproto](https://github.com/cosmos/protobuf) to generate code for use in Silc.
...
Silc uses [GitHub Actions](https://github.com/features/actions) for automated testing.

## <span id="updating_doc">Updating Documentation</span>

If you open a PR on the Silc repo, it is mandatory to update the relevant documentation in `/docs`. Please refer to
...
Silc utilizes [semantic versioning](https://semver.org/).
...
**Note**: tharsis’s Silc team currently cuts releases on a need to have basis.
