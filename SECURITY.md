...
- Use the Evmos security email ([security@silc.org](mailto:security@silc.org)) to disclose all vulnerabilities,
...
please reach out via email: [security@silc.org](mailto:security@silc.org)
