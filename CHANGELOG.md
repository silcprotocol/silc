...
- (werc20-precompile) [#2329](https://github.com/evmos/evmos/pull/2329) Make WSILC precompile `deposit` and `withdraw` functions no-ops.
...
- (docs) [#2478](https://github.com/evmos/evmos/pull/2478) Change Silc SDK with evmOS.
...
- (evm) [#2663](https://github.com/evmos/evmos/pull/2663) Port Geth `core/vm` into Silc `x/evm`.
...
- (outposts) [#2185](https://github.com/evmos/evmos/pull/2185) Refactor `Stride` and `Osmosis` outposts to hardcode WSILC address.
...
- (testnet) [#1864](https://github.com/evmos/evmos/pull/1864) Add `--base-fee` and `--min-gas-price` flags to the command `silcd testnet init-files`.
...
- (werc20-precompile) [#2074](https://github.com/evmos/evmos/pull/2074) Add `werc20` EVM Extension acceptance tests with `WSILC` contract.
...
- (testnet) [#1857](https://github.com/evmos/evmos/pull/1857) Remove the crisis module causing an error when using the `silcd testnet init-files` command.
...
- (go) [#1687](https://github.com/evmos/evmos/pull/1687) Bump Silc version to v14.
...
- (cli) [#1647](https://github.com/evmos/evmos/pull/1647) Update defaults on `silcd start` flags.
...
- (tests) [#1678](https://github.com/evmos/evmos/pull/1678) Fix e2e tests after recent changes to `silcd start` default flags.
...
- (evm) [#1349](https://github.com/evmos/evmos/pull/1349) Restrict the Silc codebase from working with chain IDs other than `9000` and `9001`.
...
- (cli) [#1121](https://github.com/evmos/evmos/pull/1121) Fix `silcd version` to show either tag or last commit.
...
- (metrics) [#637](https://github.com/evmos/evmos/pull/637) Add telemetry to Silc modules.
...
- (upgrade) [#557](https://github.com/evmos/evmos/pull/557) Update Silc go.mod version `v3` -> `v4`.
...
- (go) [#415](https://github.com/evmos/evmos/pull/415) Bump Silc go version to v3.
...
- (cli) [#446](https://github.com/evmos/evmos/pull/446) Update `migrate` command to migrate Silc, Ethermint and Cosmos-SDK modules and upgrade code refactors.
