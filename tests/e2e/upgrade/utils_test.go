...
// TestSilcVersionsLess tests the SilcVersions type's Less method with
// different version strings
func TestSilcVersionsLess(t *testing.T) {
	var version SilcVersions
...
// TestSilcVersionsSwap tests the SilcVersions type's Swap method
func TestSilcVersionsSwap(t *testing.T) {
	var version SilcVersions
	value := "v9.1.0"
...
// TestSilcVersionsLen tests the SilcVersions type's Len method
func TestSilcVersionsLen(t *testing.T) {
	var version SilcVersions = []string{"v9.1.0", "v10.0.0"}
