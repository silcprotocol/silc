def test_single_request_netversion(silc_cluster):
    silc_cluster.use_websocket()
    eth_ws = silc_cluster.w3.provider
...
def test_batch_request_netversion(silc):
    return


def test_ws_subscribe_log(silc):
    return


def test_ws_subscribe_newheads(silc):
    return
