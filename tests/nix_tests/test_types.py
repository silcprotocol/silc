...
def test_block(silc_cluster, geth):
    ...
    get_blocks(silc_cluster, geth, False)
    # Case 2: block with transactions
    get_blocks(silc_cluster, geth, True)


def get_blocks(silc_rpc_ws, geth, with_transactions):
    w3: Web3 = silc_rpc_ws.w3
    eth_rpc = w3.provider
    ...
    silc_blk = w3.eth.get_block(1)
    # Get existing block, no transactions
    eth_rsp = eth_rpc.make_request(
        "eth_getBlockByHash", [silc_blk["hash"].hex(), with_transactions]
    )
...
def test_accounts(silc_cluster, geth):
...
def test_syncing(silc_cluster, geth):
    w3: Web3 = silc_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(silc_cluster, geth):
    w3: Web3 = silc_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(silc_cluster, geth):
    w3: Web3 = silc_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(silc_cluster, geth):
    w3: Web3 = silc_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(silc_cluster, geth):
    w3: Web3 = silc_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(silc_cluster, geth):
    w3: Web3 = silc_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(silc_cluster, geth):
    w3: Web3 = silc_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(silc_cluster, geth):
...
def test_get_code(silc_cluster, geth):
    w3: Web3 = silc_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(silc_cluster, geth):
    w3: Web3 = silc_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(silc_cluster, geth):
    w3: Web3 = silc_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(silc_cluster, geth):
    w3: Web3 = silc_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(silc_cluster, geth):
    w3: Web3 = silc_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(silc_cluster, geth):
...
def test_incomplete_send_transaction(silc_cluster, geth):
