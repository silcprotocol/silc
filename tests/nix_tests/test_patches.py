...
def test_send_funds_to_distr_mod(silc_cluster):
    """
...
def test_send_funds_to_distr_mod_eth_tx(silc_cluster):
    """
    This tests the transfer of funds to the distribution module account,
    via ethereum tx
    which should be forbidden, since this is a blocked address.
...
def test_authz_nested_msg(silc_cluster):
    """
...
def test_create_invalid_vesting_acc(silc_cluster):
    """
    ...
    tx = cli.create_vesting_acc(
        ...
        "silc1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqzqpgshrm7",
    )
    try:
...
def test_vesting_acc_schedule(silc_cluster):
    """
    ...
    test_cases = [
        {
            ...
            "exp_err": "invalid decimal coin expression: -10000000000sillet",
            "lockup": {
                "start_time": 1625204910,
                "periods": [
                    {
                        "length_seconds": 2419200,
                        "coins": "10000000000sillet",
                    }
                ],
            },
            "vesting": {
...
def test_unvested_token_delegation(silc_cluster):
    """
                ...
                "periods": [
                    {
                        ...
                        "coins": "10000000000000000000sillet",
                    }
                ],
            },
            lockup_file,
            ...
            json.dump(
                {
                    ...
                    "periods": [
                        {
                            "length_seconds": 1675184400,
                            "coins": "3000000000000000000sillet",
                        },
                        {
                            "length_seconds": 2419200,
                            "coins": "3000000000000000000sillet",
                        ...
                        {
                            "length_seconds": 2419200,
                            "coins": "4000000000000000000sillet",
                        },
                    ],
                },
                vesting_file,
    ...
    del_amt = "7000000000000000000sillet"
